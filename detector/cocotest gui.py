...
label =customtkinter.CTkLabel(master=frame, text="Insert Folder path")
label.pack(pady=12, padx=10)

# path to folder box
entry1 = customtkinter.CTkButton(master=frame, text="Select", command= path_entry )
entry1.pack()

# output folder scan
text = customtkinter.CTkLabel(master=frame, width=40, height=10, text="")
text.pack()

# confirm scan
button1 = customtkinter.CTkButton(master=frame, text="Scan", command= image_scan )
button1.pack()

# image scan output
text2 = customtkinter.CTkLabel(master=frame, width=40, height=10, text="")
text2.pack()

# search intruction
label =customtkinter.CTkLabel(master=frame, text="Search elements in images")
label.pack(pady=12, padx=10)

# search box
entry2 = customtkinter.CTkEntry(master=frame, placeholder_text="Search elements in images: ")
entry2.pack(pady=12, padx=10)

# confirm search
button2 = customtkinter.CTkButton(master=frame, text="Search", command= search)
button2.pack()

# search output
text3 = customtkinter.CTkLabel(master=frame, width=40, height=10, text="")
text3.pack()
